...
fn knowledge_documentation_has_a_fixed_directory_boundary() {
    assert!(valid_target_type("documentation", "doc/5_project_knowledgebase/topic/note.md"));
    assert!(!valid_target_type("documentation", "doc/5_project_knowledgebase_extra/note.md"));
    assert!(!valid_target_type("documentation", "doc/6_other/note.md"));
    assert!(!valid_target_type("delivery", "doc/5_project_knowledgebase/note.md"));
}
