...
> 本区由项目所有。骨架更新必须逐字保留，不覆盖、删除或重新格式化。

### 项目架构红线

<!-- 填写本项目的模块职责、依赖方向、数据流和外部副作用边界。 -->

### 项目业务与安全红线

<!-- 按需填写业务、数据、风控、安全和合规约束。 -->

### 项目目录地图

<!-- 列出核心目录、入口、配置、测试和文档位置及职责。 -->

### 项目快速命令

<!-- 填写本项目真实可执行的初始化、检查、测试、构建和运行命令。 -->

### 目录级 AGENTS 索引

<!-- 按需列出项目自有的嵌套 AGENTS.md、适用目录和职责；索引不替代原生加载。 -->
