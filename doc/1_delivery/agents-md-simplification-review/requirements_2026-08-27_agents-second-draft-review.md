...
- 现行：
  ...
  - `templates/AGENTS.md`
- 第二版：
  - `doc/2_bugs/BUG-skeleton-comprehensibility-and-information-architecture-debt/proposal/factory/AGENTS.md`
  - `doc/2_bugs/BUG-skeleton-comprehensibility-and-information-architecture-debt/proposal/template/AGENTS.md`
  - `doc/2_bugs/BUG-skeleton-comprehensibility-and-information-architecture-debt/proposal/readme/bridgeforge-public-section.md`
  - `doc/2_bugs/BUG-skeleton-comprehensibility-and-information-architecture-debt/proposal/README.md`
